...
export const DndDraggable: FunctionComponent<PropsWithChildren<Props>> = ({
	children,
	containerDataProps = {},
	extendDraggableStyles,
	className,
}) => {
	...
	const handlePointerUp = (event: PointerEvent) => {
		onDragEnd(getPointerEventData(event, droppableElement), { updateOffset, setInitialOffset });
