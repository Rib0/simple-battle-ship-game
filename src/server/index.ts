...
/* 
		// Вынести room в отдельный model c методами и посмотреть на другие части стейта, все, что касается изменения server state постараться вынести в модели, внутри хендлеров ничего напрямую не менять, мб вынести из lib функции в models
