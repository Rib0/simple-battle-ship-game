...
// TODO: поправить плашку отключения над противником, чтобы была ровно над таблицей, мб перенести в компонент таблицы enemy, как и свои данные тоже в таблицу
